    ...
    <body>
        <script>
            ...
            function update(id) {
                ...
                // Added parseFloat and .toFixed(1) to allow exact price to be set, rounded off to 1 decimal place
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <%String updateId ="updateItemPricing"+listOfCountryItemPricing.get(i).getId();%>
                                                                <div hidden id="<%=updateId%>" style="float:right">
                                                                    <input type="number" min="0" max="99999.9" class="form-control" style="width:80px;" id="price<%=listOfCountryItemPricing.get(i).getId()%>" required/>
